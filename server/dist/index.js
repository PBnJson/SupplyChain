...
async function connectToDB() {
    try {
        ...
        const mongooseInstance = await mongoose.connect(process.env.MONGO_URI, clientOptions);
        const db = mongooseInstance.connection.db;
        if (!db) {
            console.error("❌ db is undefined! readyState =", mongoose.connection.readyState);
            return;
        }
